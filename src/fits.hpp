...
public:
  ...
  std::tuple<std::shared_ptr<Ipp32f>, std::shared_ptr<Ipp8u>, std::shared_ptr<Ipp8u>, std::shared_ptr<Ipp8u>, std::shared_ptr<Ipp8u>> get_video(int frame, std::string flux, std::string colourmap);
  std::tuple<std::shared_ptr<Ipp32f>, std::shared_ptr<Ipp8u>> get_frame(int frame);
