...
extern "C" {
    ...
    extern void make_video_frameF16_linear(uint16_t * src, int32_t dx, int32_t dy, int32_t src_stride, float frame_min, float frame_max, float min16, float max16, float bzero, float bscale, float ignrval, float datamin, float datamax, uint8_t * dst_luma, uint8_t * dst_mask, int32_t offset_x, int32_t offset_y, int32_t dst_stride, float black, float slope);
    extern void make_video_frameF16_logistic(uint16_t * src, int32_t dx, int32_t dy, int32_t src_stride, float frame_min, float frame_max, float min16, float max16, float bzero, float bscale, float ignrval, float datamin, float datamax, uint8_t * dst_luma, uint8_t * dst_mask, int32_t offset_x, int32_t offset_y, int32_t dst_stride, float median, float sensitivity);
    extern void make_video_frameF16_ratio(uint16_t * src, int32_t dx, int32_t dy, int32_t src_stride, float frame_min, float frame_max, float min16, float max16, float bzero, float bscale, float ignrval, float datamin, float datamax, uint8_t * dst_luma, uint8_t * dst_mask, int32_t offset_x, int32_t offset_y, int32_t dst_stride, float black, float sensitivity);
    extern void make_video_frameF16_square(uint16_t * src, int32_t dx, int32_t dy, int32_t src_stride, float frame_min, float frame_max, float min16, float max16, float bzero, float bscale, float ignrval, float datamin, float datamax, uint8_t * dst_luma, uint8_t * dst_mask, int32_t offset_x, int32_t offset_y, int32_t dst_stride, float black, float sensitivity);
    extern void make_video_frameF32_legacy(int32_t * src, int32_t width, int32_t height, float bzero, float bscale, float ignrval, float datamin, float datamax, uint8_t * dst_luma, uint8_t * dst_mask, int32_t dst_stride, float dmin, float dmax, float lmin, float lmax);
    extern void make_video_frameF32_linear(int32_t * src, int32_t width, int32_t height, float bzero, float bscale, float ignrval, float datamin, float datamax, uint8_t * dst_luma, uint8_t * dst_mask, int32_t dst_stride, float black, float slope);
    extern void make_video_frameF32_logistic(int32_t * src, int32_t width, int32_t height, float bzero, float bscale, float ignrval, float datamin, float datamax, uint8_t * dst_luma, uint8_t * dst_mask, int32_t dst_stride, float median, float sensitivity);
    extern void make_video_frameF32_ratio(int32_t * src, int32_t width, int32_t height, float bzero, float bscale, float ignrval, float datamin, float datamax, uint8_t * dst_luma, uint8_t * dst_mask, int32_t dst_stride, float black, float sensitivity);
    extern void make_video_frameF32_square(int32_t * src, int32_t width, int32_t height, float bzero, float bscale, float ignrval, float datamin, float datamax, uint8_t * dst_luma, uint8_t * dst_mask, int32_t dst_stride, float black, float sensitivity);
