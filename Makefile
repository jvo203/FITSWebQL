...
#-Imongoose
#-Ibm-3.20.0/src
DEF = -DMG_ENABLE_THREADS -DLIBUS_NO_SSL -DHAVE_INLINE -DFORCE_AVX=ON -DDEVELOPMENT -DLOCAL -DNOCLUSTER -DNOPRELOAD -DDEBUG
#-D_GLIBCXX_PARALLEL
...
omp1:
	/usr/local/opt/llvm/bin/clang++ $(CXXFLAGS) -fopenmp testOpenMP.cpp -L/usr/local/opt/llvm/lib -lomp
