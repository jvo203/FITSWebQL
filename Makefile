...
#-D_GLIBCXX_PARALLEL
LIBS = -lsqlite3 -lcurl -lcrypto -lssl -lz -lfpzip  -lpthread -lczmq -lnghttp2_asio -lboost_system -lboost_thread `pkg-config --libs OpenEXR` $(HOME)/uWebSockets/uSockets/*.o
